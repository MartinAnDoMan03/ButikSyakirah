...
Route::get('/kasir/riwayat_pesanan', [KasirController::class, 'showPesanan'])->name('kasir.riwayat_pesanan');
...
Route::get('/kasir/show_detail_pesanan', [KasirController::class, 'showOrderDetails'])->name('order.lihatDetail');
